  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-violet-50 to-indigo-50 rounded-2xl p-6 mb-8 border border-violet-100"
      >
        <div className="flex items-start gap-4">
          ...
          <div>
            <h2 className="text-lg font-bold text-violet-700 mb-1">DODOLAN</h2>
            <p className="text-gray-600">
              <span className="font-medium text-indigo-600">&quot;Dodolan&quot;</span> berasal dari bahasa Jawa yang artinya <span className="font-medium">&quot;berjualan&quot;</span>.
